        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            {displayTasks.map(task => {
              ...
              const barColor = 
                task.status === 'Done' ? 'from-emerald-450 to-emerald-555 shadow-[0_0_8px_rgba(16,185,129,0.2)]' :
                task.status === 'In Review' ? 'from-amber-455 to-amber-555 shadow-[0_0_8px_rgba(245,158,11,0.2)]' :
                task.status === 'In Progress' ? 'from-indigo-500 to-indigo-650 shadow-[0_0_8px_rgba(79,70,229,0.2)]' :
                'from-slate-350 to-slate-455';
              ...
              return (
                ...
                >
                  ...
                  <div className="w-1/3 shrink-0 pr-4">
                    <p className="text-xs font-bold text-slate-808 truncate group-hover:text-indigo-600 transition-colors">
                      {task.title}
                    </p>
