          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-50/50 dark:bg-slate-950/20 no-scrollbar">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-3.5 shadow-3xs text-center">
                ...
                <p className="text-[10px] font-bold text-slate-400 dark:text-slate-505 mt-0.5">{completedItems} completed</p>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-3.5 shadow-3xs text-center">
                <span className="text-[10px] font-black uppercase tracking-wider text-slate-400 dark:text-slate-505">Logged Hours</span>
                <p className="text-xl font-black text-amber-600 tracking-tight mt-0.5">{totalHoursLogged}h</p>
                <p className="text-[10px] font-bold text-slate-400 dark:text-slate-505 mt-0.5">Total recorded</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                {totalItems > 0 && (
                  <span className="text-[10px] font-bold text-slate-405 dark:text-slate-500">
                    ...
                    >
                      <div className="min-w-0 flex-1 space-y-1">
                        <div className="flex items-center gap-2">
                          <span className={cn(
                            ...
                            item.itemType === 'issue' ? "bg-rose-50 dark:bg-rose-955/20 text-rose-600 dark:text-rose-450 border border-rose-100 dark:border-rose-900/30" : "bg-indigo-50 dark:bg-indigo-950/20 text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900/30"
                          )}>
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <span className={cn(
                          ...
                          item.priority === 'High' ? "bg-amber-50 dark:bg-amber-955/20 text-amber-600 dark:text-amber-400" : "bg-slate-100 dark:bg-slate-950 text-slate-500 dark:text-slate-400"
                        )}>
                          {item.priority}
                        </span>
                        ...
                        <span className={cn(
                          ...
                          item.status === 'In Progress' ? "bg-indigo-50 dark:bg-indigo-955/20 text-indigo-600 dark:text-indigo-400 border-indigo-100 dark:border-indigo-900/30" :
