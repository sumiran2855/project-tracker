...
export function AddTaskModal({
  ...
  const handleCreateTask = async (e: React.FormEvent) => {
    ...
    const selectedAssignees = newAssignees.map((name) => {
      ...
      return {
        ...
        bg: found?.bg || 'bg-indigo-100 text-indigo-700',
      };
    });
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-md animate-fadeIn">
      ...
      `}} />
      <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-[0_24px_50px_-12px_rgba(0,0,0,0.12)] p-6 sm:p-8 space-y-6 animate-scaleIn max-h-[90vh] flex flex-col">
