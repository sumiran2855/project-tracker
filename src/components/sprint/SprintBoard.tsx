          ...
          >
            <div className="flex items-center justify-between border-b border-slate-200/60 pb-3 mb-4 shrink-0">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-black text-slate-808 tracking-tight">{col}</span>
              </div>
              ...
              {colItems.length === 0 ? (
                ...
                colItems.map(item => (
                  ...
                  >
                    ...
                    <p className="text-[10px] text-slate-455 font-bold mt-1 flex items-center gap-1 truncate">
