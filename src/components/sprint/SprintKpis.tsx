    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 animate-fadeIn">
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 p-5 flex items-center gap-5 shadow-3xs">
        <div className="relative flex h-20 w-20 items-center justify-center shrink-0">
          ...
          <span className="absolute text-sm font-black text-slate-805">{completionPercentage}%</span>
        </div>
        <div>
          <p className="text-[10px] font-black uppercase tracking-wider text-slate-400 font-sans">Weekly Progress</p>
          <h3 className="text-lg font-black text-slate-808 tracking-tight mt-0.5">
            {completionPercentage === 100 ? "Sprint Finished! 🎉" : "Almost there"}
          </h3>
          <p className="text-slate-455 text-[11px] font-semibold mt-1">
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 p-5 shadow-3xs flex items-center gap-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-805 tracking-tight mt-0.5">{completedTasksCount} / {totalTasksCount}</h3>
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 p-5 shadow-3xs flex items-center gap-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-805 tracking-tight mt-0.5">{resolvedIssuesCount} / {totalIssuesCount}</h3>
          <div className="w-24 h-1 bg-slate-100 rounded-full mt-1.5 overflow-hidden">
            <div 
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 p-5 shadow-3xs flex items-center gap-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-808 tracking-tight mt-0.5">{totalLoggedHours}h</h3>
          <p className="text-[11px] font-semibold text-slate-455 mt-1">Logged work time</p>
        </div>
      </div>
    </div>
  );
