  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-200/80 dark:border-slate-800 pb-5">
      <div>
        ...
        <p className="text-slate-400 dark:text-slate-500 text-xs font-bold mt-1 flex items-center gap-1.5">
          <Calendar className="h-3.5 w-3.5 text-slate-400" />
          <span>Timeframe: <span className="text-slate-700 dark:text-slate-300">{weekRangeStr}</span></span>
          <span className="h-1.5 w-1.5 rounded-full bg-slate-300 mx-1" />
          <span className="px-2 py-0.5 rounded-full bg-indigo-50 dark:bg-indigo-950/20 text-indigo-600 dark:text-indigo-400 font-extrabold text-[9px] uppercase tracking-wider">
            Sprint Active
          </span>
        </p>
      </div>
        ...
        <div className="bg-slate-100 dark:bg-slate-950 p-1 rounded-2xl flex items-center border border-slate-200 dark:border-slate-800">
          <button
            ...
            className={cn(
              ...
              viewMode === 'board' ? "bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-100 shadow-2xs" : "text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200"
            )}
          >
          ...
          <button
            ...
            className={cn(
              "p-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5",
              viewMode === 'sheet' ? "bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-100 shadow-2xs" : "text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200"
            )}
          >
