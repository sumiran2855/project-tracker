...
export function ManageCollaboratorsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto animate-fadeIn">
      <div className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl p-6 sm:p-8 space-y-6 my-8 animate-scaleIn">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-base font-black text-slate-800 dark:text-slate-100">Manage Collaborators</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={onAddCollaborator} className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Colleague Name</label>
                <select
                  required
                  ...
                  className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 px-3.5 py-2 text-xs text-slate-900 dark:text-slate-100 focus:border-indigo-500 focus:outline-none cursor-pointer"
                >
                  <option value="" className="dark:bg-slate-900">-- Select Colleague --</option>
                  {systemEmployees
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  value={newCollabRole}
                  className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 px-3.5 py-2 text-xs text-slate-500 focus:outline-none cursor-not-allowed"
                />
              </div>

              <div className="space-y-1.5">
                <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 block">Avatar Accent color</label>
            ...
            <div className="flex justify-end">
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-800 text-white px-4 py-2 text-xs font-bold cursor-pointer transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed min-w-[120px] justify-center"
              >
                {isAddingColleague ? (
                  <>
          ...
          <div className="space-y-3.5 pt-4 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="max-h-[160px] overflow-y-auto space-y-2.5 pr-1">
              {collabs.map((c) => (
                <div key={c.email || c.name} className="flex items-center justify-between border border-slate-100 dark:border-slate-800 rounded-xl p-2 bg-slate-50/50 dark:bg-slate-950/20">
                  ...
                  <button
                    ...
                    className="text-slate-400 dark:text-slate-500 hover:text-red-500 transition-colors p-1 cursor-pointer"
                  >
