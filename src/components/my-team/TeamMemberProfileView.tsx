...
export function TeamMemberProfileView({
  ...
  return (
    <div className="animate-fadeUp">
      ...
      <button
        onClick={onBack}
        className="group mb-6 inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-bold text-slate-700 shadow-3xs transition-all hover:bg-slate-50 hover:text-slate-800 cursor-pointer"
      >
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="text-center sm:text-left space-y-2.5">
            <div className="flex flex-col sm:flex-row items-center gap-3">
              <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-800">{member.name}</h1>
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-2xs space-y-4">
            ...
            {hasSkills ? (
              ...
              <div className="rounded-2xl border border-dashed border-slate-200 p-6 text-center">
                ...
                <p className="text-[11px] font-bold text-slate-400">No skill set is yet set</p>
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-2xs space-y-4">
            ...
            {member.projects.length === 0 ? (
              <div className="border-2 border-dashed border-slate-200 rounded-2xl p-8 text-center">
                ...
                <p className="text-xs font-bold text-slate-600">No Projects Assigned</p>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-2">
                        <div className="h-8 w-8 rounded-lg bg-indigo-50 flex items-center justify-center text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                    ...
                    <div className="flex items-center justify-between text-[10px] pt-1">
                      <span className="font-bold text-slate-400">Board Status:</span>
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-2xs space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="border border-slate-100 rounded-2xl p-4 bg-slate-50/20">
                ...
                <p className="text-[10px] text-slate-400 mt-1">Cross-project collaborations.</p>
              </div>
              <div className="border border-slate-100 rounded-2xl p-4 bg-slate-50/20">
                ...
                <p className="text-[10px] text-slate-400 mt-1">Balanced task distribution.</p>
              </div>
            </div>
          </div>
        </div>
