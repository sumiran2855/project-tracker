      ...
      <div className="relative w-full max-w-xl h-full bg-white dark:bg-slate-900 shadow-2xl border-l border-slate-200 dark:border-slate-800 flex flex-col justify-between animate-slideIn">
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar p-6 sm:p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-505 dark:text-slate-400 font-medium leading-relaxed bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-4">
          ...
          <div className="grid grid-cols-2 gap-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 rounded-2xl shadow-3xs">
            ...
            <div className="col-span-2 border-t border-slate-100 dark:border-slate-800 pt-3.5 space-y-2 animate-fadeIn">
              <span className="text-[9px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider block">Hours Spent (Actual)</span>
            ...
            <div className="col-span-2 grid grid-cols-2 gap-4 border-t border-slate-100 dark:border-slate-800 pt-3.5">
              <div>
                <span className="text-[9px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider block">Start Date</span>
              ...
              <div>
                <span className="text-[9px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider block">Due Date</span>
                <span className="text-xs font-bold text-slate-600 dark:text-slate-300 flex items-center gap-1.5 mt-1">
          ...
          {/* Assignees */}
          <div className="space-y-2">
            <span className="text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider">Assignees</span>
                ...
                selectedTask.subtasks.map(sub => (
                  <div key={sub.id} className="flex items-center justify-between group/sub">
                    ...
                    >
                      ...
                      <span className={cn("text-xs font-bold transition-all", sub.completed ? "line-through text-slate-400 dark:text-slate-500" : "text-slate-707 dark:text-slate-300")}>
                        {sub.title}
                      </span>
                    </button>
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="space-y-3.5 pt-2">
              {[...(selectedTask.comments || [])]
                ...
                .map(comment => (
                  <div key={comment.id} className="flex gap-3 bg-slate-50/50 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-800 p-3 rounded-2xl">
