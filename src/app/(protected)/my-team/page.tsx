...
export default function MyTeamPage() {
  ...
  // If a member is selected, display their detailed profile page
  if (selectedMember) {
    ...
    return (
      <div className="min-h-full bg-slate-50 p-4 sm:p-6 md:p-8 lg:p-10">
        ...
        <button
          ...
          className="group mb-6 inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-bold text-slate-600 shadow-3xs transition-all hover:bg-slate-50 hover:text-slate-800 cursor-pointer"
        >
        ...
        {/* Profile Card Header */}
        <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-200 p-6 sm:p-8 text-slate-800 shadow-3xs mb-8">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-2xs space-y-4">
              ...
              <div className="space-y-3.5 text-xs">
                ...
                <div className="flex justify-between items-center py-2">
                  <span className="font-semibold text-slate-450">Location</span>
                  <span className="font-bold text-slate-700">Remote / Hybrid</span>
                </div>
              </div>
            </div>
          </div>
                  ...
                  {member.projects.map(proj => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-[10px] pt-1">
                        <span className="font-bold text-slate-450">Board Status:</span>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-2xs space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="border border-slate-100 rounded-2xl p-4 bg-slate-50/20">
                  ...
                  <span className="text-xl font-black text-slate-800 mt-1 block">{member.projects.length} Boards</span>
                ...
                <div className="border border-slate-100 rounded-2xl p-4 bg-slate-50/20">
                  ...
                  <span className="text-xl font-black text-slate-800 mt-1 block">Optimal</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-white p-4 rounded-2xl border border-slate-200 shadow-3xs">
            <div className="relative w-full sm:max-w-xs">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl text-xs focus:outline-indigo-550 placeholder-slate-400"
              />
            </div>
                      ...
                      {member.projects.length === 0 ? (
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {member.projects.slice(0, 3).map(proj => (
                            <span
                              key={proj.id}
                              className="inline-flex items-center gap-1 bg-slate-50/50 border border-slate-200/60 px-2 py-1 rounded-lg text-[9px] font-extrabold text-slate-600 shadow-3xs hover:border-indigo-250 transition-colors"
                            >
                          ...
                          {member.projects.length > 3 && (
                            <span className="inline-flex items-center bg-slate-105 px-2 py-1 rounded-lg text-[9px] font-extrabold text-slate-500">
